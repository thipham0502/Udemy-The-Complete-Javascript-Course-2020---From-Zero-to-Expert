...
// 5.
poll.displayResults.call({ answers: [ 5, 2, 3 ] }, 'string'); //pass new object with different answers array and the argument 'type'
poll.displayResults.call({ answers: [ 1, 5, 3, 9, 6, 1 ] }, 'array'); //pass new object with different answers array and the argument 'type'
poll.displayResults.call({ answers: [ 1, 5, 3, 9, 6, 1 ] }); //pass new object with different answers array and the argument 'type'
